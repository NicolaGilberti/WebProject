...
public class NotificationUpdateJsp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("noty",notbean);
        
        RequestDispatcher ds = request.getRequestDispatcher("notification.jsp");
