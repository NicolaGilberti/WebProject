...
<!DOCTYPE html-->
            <ul class="nav nav-tabs" style="display: inline">
                 <li class="active"><a data-toggle="tab" href="#menu"><h3><strong>Notification not viewed</strong> <span class="badge">${fn:length(resnoty.review_list)}</span></h3></a></li>
                 <li><a data-toggle="tab" href="#menu1"><h3><strong>Notification viewed </strong><span class="badge"></span></h3></a></li>
            </ul>
